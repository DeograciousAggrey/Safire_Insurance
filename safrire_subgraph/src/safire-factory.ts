...
import { SafirePool } from "../generated/SafireFactory/SafirePool"
import { InsurancePool } from "../generated/schema"
import { getOrCreateToken } from "./token"
import { SafirePool as SafirePoolTemplate } from "../generated/templates"
...
export function handleInsuranceCreated(event: InsuranceCreated): void {
  ...
  if (pool == null) {
    ...
    let instance = SafirePool.bind(event.params.target)
    ...
    SafirePoolTemplate.create(event.params.target);
